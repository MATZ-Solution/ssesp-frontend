      ...
      <div className="relative min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 text-white">
          ...
          <div className="grid grid-cols-2 gap-4 my-8">
            {[
              { icon: TrendingUp, text: "Real-time Analytics", display: "Scholarship Coverage" },
              { icon: Shield, text: "Secure & Encrypted", display: "Eligibility Criteria" },
              { icon: BarChart3, text: "Visual Form", display: "Selection Criteria" },
              { icon: Zap, text: "Lightning Fast", display: "Application Process" },
            ].map((feature, idx) => (
              <button
                key={idx}
