...
export const BFormField = ({ control, errors, watchNoBForm }) => {
  return (
    <div>
      {!watchNoBForm ? (
        ...
        <div>
          <label className="text-sm font-semibold text-gray-700 mb-1.5 block">
            Student B-Form <span className="text-red-500" aria-label="required">*</span>
          </label>
          <div className="w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-gray-50">
            <span className="text-gray-600 font-medium">Applied For</span>
          </div>
